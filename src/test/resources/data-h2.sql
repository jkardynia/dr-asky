INSERT INTO location (id, name, city, street, house_number, lat, lng) VALUES
  (1, 'office', 'Cracow', 'ul. Rynek', '1', '50.062023', '19.936422'),
  (2, 'home', 'Cracow', 'Ul. Opolska', '1', '50.091593', '19.934426');

INSERT INTO profile(id, home_location_id, username, timezone, locale) values(1, 2, 'default', 'Europe/Warsaw', 'pl-PL');
...
INSERT INTO bus_route (id, direction, line_number, stop_name, from_id, to_id) VALUES(1, 'Pradnik Bialy - Rzaka', '144', 'Pachonskiego', 2, 1);
